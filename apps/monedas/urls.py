...
from . import views
from .views import tabmonedas,index,index1,get_crypto_data,moneda,MonedaCreate,MonedaInfo,MonedaList
...
urlpatterns = [
   ...
   #url(r'^monedainfo/$',MonedaInfo.as_view(), name='moneda_info'),
